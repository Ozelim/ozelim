    ...
    <main className="max-w-6xl m-auto">
      <div className="text-center">
        <img
          ...
          alt=""
        />
        <h1 className="text-4xl font-bold mt-1 text-[#2a2a2a]">
      ...
      <section className="flex mt-20">
        ...
        <img className="max-w-2xl" src={SportIcon} alt="sport" />
      </section>
      <section className="text-center mt-24">
        ...
        <div className="flex justify-center items-center gap-10 mt-10">
          <Link to="/" className="">
            <div className="border border-solid border-gray-300 rounded-full p-7 hover:bg-teal-600 transition-all ">
              <AiOutlineInstagram className="text-7xl flex-shrink-0 text-primary-500 hover:text-white" />
            </div>
            <p className="text-primary-600 mt-2">Instagram</p>
          </Link>
          <Link to="/" className="">
            <div className="border border-solid border-gray-300 rounded-full p-7 hover:bg-teal-600 transition-all ">
              <AiOutlineWhatsApp className="text-7xl flex-shrink-0 text-primary-500 hover:text-white" />
            </div>
            <p className="text-primary-600 mt-2">WhatApp</p>
          </Link>
          <Link to="/" className="">
            <div className="border border-solid border-gray-300 rounded-full p-7 hover:bg-teal-600 transition-all ">
              <AiOutlineYoutube className="text-7xl flex-shrink-0 text-primary-500 hover:text-white" />
            </div>
            <p className="text-primary-600 mt-2">YouTube</p>
          </Link>
        </div>
        <h3 className="mt-5 font-medium text-[#2a2a2a] text-2xl">
