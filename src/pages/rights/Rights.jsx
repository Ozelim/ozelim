...
const acc = [
  ...
  {
    label: `ждународное правовое сопровождение`,
    description: 
    <>
  ...
  {
    label: `Регистрация и сопровождение эндаумент-фондов`,
    description: 
    <>
      <p>Эндаумент-фонды играют важную роль в поддержке долгосрочных проектов, и Ассоциация предлагает помощь в их создании и управлении. Услуги включают:</p>
      <ul className='list-disc px-6 mt-4'>
        <p>Регистрация эндаумент-фондов для финансирования туристических инициатив;</p>
        <p>Сопровождение деятельности фондов и обеспечение их соответствия законодательству;</p>
        <p>Привлечение доноров и управление активами фондов.</p>
      </ul>
      <p className='font-bold mt-4'>Преимущества:</p>
      <p>Эндаумент-фонды позволяют членам Ассоциации финансировать долгосрочные проекты и обеспечивать устойчивое развитие туристической отрасли.</p>
    </>
  },
  {
            ...
            {acc.map((q, i) => {
              return (
                <Accordion.Item value={`${i}`}>
                  <Accordion.Control className='!text-xl !font-bold'>{i + 1}. {q?.label}</Accordion.Control>
