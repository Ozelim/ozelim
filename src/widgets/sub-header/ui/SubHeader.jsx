      ...
      <div className="flex justify-center py-3 border-b">
        <div>
          <a href="https://wa.me/77470512252" className="flex items-center">
            <p className="whitespace-nowrap text-sm md:text-base text-zinc-400">
              {kz ? `Бізбен байланысыңыз` : 'Служба поддержки'}:
            </p>
            <p className="hidden md:block text-sm md:text-base text-zinc-400 ml-1">
